...
<section class="banner-section">
    ...
    <div class="banner-carousel owl-theme owl-carousel owl-nav owl-dots-none">
        ...
        <div class="slide-item" style="background-image: url(assets/images/home-banner-3.jpg);">
            <!-- <div class="pattern-box">
                <div class="pattern-1"></div>
                <div class="pattern-2"></div>
                <div class="pattern-3" style="background-image: url(assets/images/shape/shape-2.png);"></div>
        ...
        <div class="slide-item" style="background-image: url(assets/images/home-banner-1.jpg);">
            <!-- <div class="pattern-box">
                <div class="pattern-1"></div>
                <div class="pattern-2"></div>
                <div class="pattern-3" style="background-image: url(assets/images/shape/shape-2.png);"></div>
            ...
            <div class="owl-stage-outer">
                <div class="owl-stage">
                    ...
                    <div class="owl-item">
                        <div class="testimonial-block-one">
                            <div class="inner-box">
                                <img src="assets/images/clients/new-4.png" alt="">
                            </div>
                        </div>
                    </div>
                    <div class="owl-item">
                    ...
                    <div class="owl-item">
                      ...
                      <div class="owl-item">
                        <div class="testimonial-block-one">
                            <div class="inner-box">
                                <img src="assets/images/clients/new-16.png" alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="testimonial-block-one">
                <div class="inner-box  bg-light testimonial-feedback">
                    <div class="inner">
                        ...
                        <p> I am Arul Gupta from Mahatva Ayurveda(Panchkula). We've been working with Yasharyn Packaging for a long time, Yash Aryan Company offers a great variety of high-quality products. Their staff, especially Rakshanda Ma'am, is very kind, humble, and professional. She promptly answers calls and provides excellent assistance. Her behavior and communication are truly commendable. I am very happy to work with Yash Aryan Company</p>
                        <h4>Arul Gupta</h4>
            ...
            <div class="testimonial-block-one">
                <div class="inner-box bg-light testimonial-feedback">
                    <div class="inner">
                        ...
                        <p>I'm Pushpinder from Growell Pharmacy. We've been working with Yasharyn Packaging for a long time, and it's been a great experience throughout. Their service is reliable, the quality is always up to the mark, and they’ve been very professional in every interaction.
                        </p>
                        <p>Really happy to be associated with them and looking forward to more years of working together!</p>
                        <h4>Pushpinder </h4>
            ...
            <div class="testimonial-block-one">
                <div class="inner-box bg-light testimonial-feedback">
                    <div class="inner">
                        ...
                        <p>We've been working with Yasharyn Packaging for a long time, and it's been a great experience throughout. Their service is reliable, the quality is always up to the mark, and they’ve been very professional in every interaction.</p>
                        <p>Really happy to be associated with them and looking forward to more years of working together!</p>
                         <h4>Amit Gupta  </h4>
                        <p>Laborate pharmaceutical india Ltd.</p>
                    </div>
                </div>
            </div>
            <div class="testimonial-block-one">
                <div class="inner-box bg-light testimonial-feedback">
                    <div class="inner">
                        ...
                        <p>As you are aware we are currently dealing with many packing suppliers/manufacturers and they are also doing the good job but here I would like to take an opportunity to congratulate Yasharyan Packaging Team as they also provide commendable supply and services.Hope you will continue the same service in future also and  special thanks to Kiran Mam for her proper response regarding the timely delivery and services. </p>
