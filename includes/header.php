...
<html lang="en">
   ...
   <body>
                              ...
                              <ul>
                                 ...
                                 <li class="dropdown">
                                    ...
                                    <ul>
                                       ...
                                       <li <?php if(!empty($sub_category['sub_categories2'])) { ?>class="dropdown parent-category" <?php } ?>>
                                          <a  href="products.php?category_id=<?php echo $sub_category['id']; ?>"> <?php echo $sub_category['category_name']; ?> </a>
                                          
                                          <ul class="subcategory2 ">
                                             <?php foreach($sub_category['sub_categories2'] as $sub_category2) { ?>
                                             <li><a  href="products.php?category_id=<?php echo $sub_category2['id']; ?>">  <?php echo $sub_category2['category_name']; ?></a> </li>
               ...
               <ul class="nav-right ml-5">
                  <li class="search-box-outer">
                     <div class="dropdown">
                        ...
                        <div class="dropdown-menu search-panel" id="product-search"
         ...
         <div class="sticky-header">
            <div class="outer-box">
               ...
               <ul class="nav-right">
                  ...
                  <!-- <li class="btn-box display-flex align-items-center justify-content-center">
                     <a href="javascript:;" class="theme-btn btn-one">Request A Quote</a>
                     </li> -->
               </ul>
            </div>
      ...
      <!-- <header class="main-header">
         <div class="row">
             <div class="col-6 col-lg-4 m-auto text-center">
                 <div class="">
                     <figure class="logo"><a href="index.php"><img src="assets/images/logo.png" alt=""></a></figure>
                 </div>
             </div>
                         ...
                         <div class="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                             <ul class="navigation clearfix">
                                 ...
                                 <li class="dropdown"><a href="#">Products</a>
                                     <ul>
         <?php foreach($categories as $category) { ?>
         <li class="dropdown"><a href="products.php?category_id=<?php echo $category['id']; ?>"><?php echo $category['category_name']; ?></a>
         <ul>
            <?php foreach($category['sub_categories'] as $sub_category) { ?>
                                                 <li><a href="products.php?category_id=<?php echo $sub_category['id']; ?>"><?php echo $sub_category['category_name']; ?></a></li>
                                                 <?php } ?>
                                             </ul>
                                         </li>
         <?php } ?>
                         ...
                         <div class="dropdown">
                             ...
                             <div class="dropdown-menu search-panel" id="product-search" aria-labelledby="dropdownMenu3">
                                 <div class="form-container">
                                     <form method="get" action="result.php" >
                                         <div class="form-group">
                                             <input type="search" name="keyword" value="" placeholder="Search product name, size, category" required="">
